function TrainCluster_Weight = t1_show_cal_cluster_wt_update(cluster_Sum, data2cluster, myopt, frame, sp_index_pre)
%% Copyright (C) Shu Wang.
%% All rights reserved.

train_frame_num = myopt.update_incre_num;
...
for f = 1:train_frame_num
    ...
    clear temp_labels tmpl temp_warp_p costheta sintheta x0 y0;
end 
